...
#include "intrinsic_extensions_gcc.h"
    ...
    /// </summary>
    template <typename T>
    inline internal::SymdRegister<T> blend(
        const internal::SymdRegister<T>& selector,
        const internal::SymdRegister<T>& first,
        const internal::SymdRegister<T>& second)
    {
    ...
    /// </summary>
    template <typename R, typename T>
    internal::SymdRegister<R> convert_to(const internal::SymdRegister<T>& in)
    {
...
namespace std
{
    ...
    template <typename T>
    inline SymdRegister<T> min(const SymdRegister<T>& first, const SymdRegister<T>& sec)
    {
        return first.min(sec);
    }

    template <typename T>
    inline SymdRegister<T> max(const SymdRegister<T>& first, const SymdRegister<T>& sec)
    {
        return first.max(sec);
    }

    template <typename T>
    SymdRegister<T> abs(const SymdRegister<T>& reg)
    {
        return reg.abs();
    }
}
